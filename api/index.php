...
$app->get('/times', function () use ($app) {
    $times_array = array(
		...
		array( "id" => "25",   "from" => "115",  "to" => "118",    "time" => "" ),
		array( "id" => "26",   "from" => "119",  "to" => "122",    "time" => "" ),
		array( "id" => "27",   "from" => "123",  "to" => "126",    "time" => "" ),
		array( "id" => "28",   "from" => "127",  "to" => "130",    "time" => "17th Century" ),
		array( "id" => "29",   "from" => "131",  "to" => "134",    "time" => "1986" ),
		array( "id" => "30",   "from" => "135",  "to" => "140",    "time" => "" ),
		array( "id" => "31",   "from" => "141",  "to" => "144",    "time" => "1746" ),
		array( "id" => "32",   "from" => "145",  "to" => "148",    "time" => "" ),
		array( "id" => "33",   "from" => "149",  "to" => "152",    "time" => "2070" ),
		array( "id" => "34",   "from" => "153",  "to" => "156",    "time" => "" ),
		array( "id" => "35",   "from" => "157",  "to" => "162",    "time" => "1966" ),
		array( "id" => "36",   "from" => "163",  "to" => "169",    "time" => "1867" ),
